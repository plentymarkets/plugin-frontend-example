...
namespace PluginFrontendExample\Extensions;
 ...
 * @package PluginFrontendExample\Extensions
 */
class TwigServiceProvider extends Twig_Extension
{
    ...
    {
        return "PluginFrontendExample_Extension_TwigServiceProvider";
    }
    ...
    {
        return [
            "pluginFrontendExampleDonationService" => [
                "donationService" => pluginApp(PluginFrontendExampleDonationService::class)
            ]
        ];
    }
}
